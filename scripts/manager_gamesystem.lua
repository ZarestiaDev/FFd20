...
function onInit()
	...
	languages = {
		...
		[Interface.getString("language_value_grippli")] = "";
		...
		[Interface.getString("language_value_vanaran")] = "";
		[Interface.getString("language_value_vishkanya")] = "";
	}
	languagefonts = {
		[Interface.getString("language_value_celestial")] = "Celestial",
		[Interface.getString("language_value_draconic")] = "Draconic",
